...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    */
    ...
    wp_localize_script( 'bones-js', 'object_name', $translation_array );
...
function my_nav_wrap() {
  ...
  //$wrap .= '<li class="icon"><a class="search-toggle" href="#"><img src="'.get_template_directory_uri().'/library/images/search_icon.png"></a></li>';
...
function bones_main_nav() {
  // display the wp3 menu if available
    wp_nav_menu(array(
      ...
      'items_wrap' => my_nav_wrap(),												// adding any static menu items not included in wordpress admin
