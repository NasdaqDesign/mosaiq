					...
					<ul class="participant__assets">';
						if(!empty($participant_meetings)){
							...
							foreach($participant_meetings as $meeting){
								...
								if($meeting['interview_campaign'] == $post->ID && isset($meeting['vimeo'])){
									$vimeoCount++;
								}
								if($meeting['interview_campaign'] == $post->ID && isset($meeting['interview_campaign_summary'])){
									$summaryCount = count($meeting['interview_campaign_summary']);
								}
							}
						}
						...
						renderAsset($vimeoCount, 'fa-youtube-play', 'Usability Video');
						renderAsset($summaryCount, 'fa-sticky-note-o', 'Interview Summary');
