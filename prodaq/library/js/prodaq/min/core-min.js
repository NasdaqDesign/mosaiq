...
(function($){
	...
	// using the meetings json doc generated by the stats template
		// $.ajax({
		// 	url: templateUrl + '/library/data/meetings.json',
		// 	type: 'GET',
		// 	dataType: 'json',
		// 	success: function(data){
		// 		for(var i = 0; i<data.length; i++){
		// 			console.log(data[i].participant);
		// 		}
		// 	}
		// });
		...
		$window.on('scroll', function () {
			if ($window.scrollTop() >= 50) {
					$('.prodaq-nav').addClass('filled');
			}
			else{
					$('.prodaq-nav').removeClass('filled');
			}
		});

		// Stellar Paralax LAME. blame dansel
		// ------------------------------------------------------------------------------------------
		$window.stellar({
