<div class="form-section">
	...
	<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-discover button">Add Discovery Resource</a></p>
</div>
