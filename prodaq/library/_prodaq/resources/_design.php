<div class="form-section">
	...
	<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-design button">Add Design Resource</a></p>
</div>
