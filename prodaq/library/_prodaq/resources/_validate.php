<div class="form-section">
	...
	<p style="margin-bottom:15px; padding-top:5px;"><a href="#" class="docopy-validate button">Add Validate Resource</a></p>
</div>
